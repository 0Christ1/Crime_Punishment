  ...
  <div class="content-img">
    <div class="content shadow">
        ...
        <form id="myForm" method="post">
            <div class="row mb-3">
                <div class="col-sm-6">
                    <input type="text" id="crime code" class="form-control" placeholder = "Crime Code" name="code" value="<?php echo htmlspecialchars($code); ?>"<?php echo htmlspecialchars($id); ?>" required oninvalid="setCustomValidity('Crime Code is required.')" oninput="setCustomValidity('')">
                </div>
            </div>
