    ...
    <div class="content-img">
      <div class="content shadow">
        ...
        <form method="post">
            <div class="row mb-3">
                <div class="col-sm-6">
                    <input type="text" id="crime charge" class="form-control" placeholder = "Charge ID" name="id" value="<?php echo htmlspecialchars($id); ?>"required oninvalid="setCustomValidity('Crime Charge ID is required.')" oninput="setCustomValidity('')">
                    </div>
                </div>
            </div>
